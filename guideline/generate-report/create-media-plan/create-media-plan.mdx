...
<Steps>
  ...
  <Step title="Click the 'Save Changes' Button">
    ...
    After successfully creating the media plan, its default status will be 'Draft'. You can continue configuring the media plan by changing the schedule if necessary (See Changing the Schedule). If there are no changes to the media plan schedules, you can proceed directly to selecting the Inventory that will run your campaign (See Select Inventories).
  </Step>
</Steps>
